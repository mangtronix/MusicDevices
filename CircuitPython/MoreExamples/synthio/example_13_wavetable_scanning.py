...
# Modified by Michael Ang for Music Devices
# - use external DAC with these pins
#   - LRC  - A0
#   - BCLK - A1
#   - DIN  - A2
...
buffer_size = 4096 # buffering for audiomixer to prevent crackles when processor is busy
...
# Feather RP2040 with external DAC
# https://learn.adafruit.com/adafruit-max98357-i2s-class-d-mono-amp/pinouts#i2s-pins-2693322
lrc_pin = board.A0
bclk_pin = board.A1
din_pin = board.A2
audio = audiobusio.I2SOut(lrc_pin, bclk_pin, din_pin)
...
mixer = audiomixer.Mixer(buffer_size=buffer_size, voice_count=4, sample_rate=sample_rate, channel_count=1,
